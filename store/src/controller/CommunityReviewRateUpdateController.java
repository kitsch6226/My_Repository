...
@Component("/main/updateCommunityReviewRate.go")
public class CommunityReviewRateUpdateController implements Controller, DataBinding {
	private ReviewDao reviewDao;

	public CommunityReviewRateUpdateController setReviewDao(ReviewDao reviewDao) {
